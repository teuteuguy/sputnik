...
try:
    ...
    PUB.publish(IOT_TOPIC_SHADOW_UPDATE, { "state": { "desired": { "belt": { "mode": BELT_MODE_FORWARD, "speed": BELT_DEFAULT_SPEED } } } })
            ...
            try:
                ...
                if probability > 0.6:
                    ...
                    if prob_no_hat > 0.8: # definitely not safe
                        PUB.publish(IOT_TOPIC_SHADOW_UPDATE, { "state": { "desired": { "belt": { "mode": BELT_MODE_STOP, "speed": BELT_DEFAULT_SPEED } } } })
