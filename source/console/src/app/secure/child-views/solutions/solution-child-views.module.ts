...
@Component({
    ...
    template: `
        <app-aws-mini-connected-factory-v1 *ngIf="solution.solutionBlueprintId === 'aws-mini-connected-factory-v1.0'" [solution]="solution"></app-aws-mini-connected-factory-v1>
    `
})
