...
class MTMThingGroups {
    ...
    createThingGroup(groupName, description, isMaster = false) {
        console.log('createThingGroup', groupName, description, isMaster);
        let params = {
            thingGroupName: PREFIX + groupName,
        ...
        if (!isMaster) {
            params.parentGroupName = PREFIX + ROOT;
        }
        console.log('createThingGroup params', params);
    ...
    //                     return group.groupName === PREFIX + gn;
    //                 }) !== -1
    //             ) {
    ...
    //             iot
    //             .describeThingGroup({
    //                 thingGroupName: PREFIX + thingGroupName
    //             })
    //             .promise(),
    //             iot
    //             .listThings({
